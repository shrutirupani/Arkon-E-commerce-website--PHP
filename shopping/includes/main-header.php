...
<div class="logo">
	<a href="index.php">
		...
		<h3><img src="img/logo_1.png" height="30px" width="30px"/>Arkon Electronics</h3>
...
<div class="search-area">
	<button  style="float: right;height:45px;" id="pause-record-btn" title="Pause Recording"><i class="fa fa-stop"></i></button>		
	<button style="float: right;height:45px;" id="start-record-btn" title="Start Recording"><i class="fa fa-play"></i></button>
         
    <form  method="post" action="search-result.php">
        <div class="control-group">			
			<input class="search-field" id="note-textarea" placeholder="Search here..." name="product" required="required" />			
