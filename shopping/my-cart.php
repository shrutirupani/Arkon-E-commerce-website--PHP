...
while ($rt=mysqli_fetch_array($qry)) {
	echo "<b>Address: </b>". htmlentities($rt['shippingAddress'])."<br />";
	echo "<b>City: </b>". htmlentities($rt['shippingCity'])."<br />";
	echo "<b>Province: </b>". htmlentities($rt['shippingState'])."<br />";
	echo "<b>Postal Code: </b>". htmlentities($rt['shippingPincode']);
}
	
						?>
						<br /><br />
	<a href="bill-ship-addresses.php" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
						</div>
		...
		<tbody>
				<tr>
					<td>
						...
						<?php $qry=mysqli_query($con,"select * from users where id='".$_SESSION['id']."'");
while ($rt=mysqli_fetch_array($qry)) {
	echo "<b>Address: </b>". htmlentities($rt['billingAddress'])."<br />";
	echo "<b>City: </b>". htmlentities($rt['billingCity'])."<br />";
	echo "<b>Province: </b>". htmlentities($rt['billingState'])."<br />";
	echo "<b>Postal Code: </b>". htmlentities($rt['billingPincode']);
}
