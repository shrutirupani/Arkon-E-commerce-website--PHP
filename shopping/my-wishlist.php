...
?>
						...
						<div class="price">$ 
							...
							<span>$<?php echo htmlentities($row['ppDiscount']);?>.00</span>
						</div>
					</td>
					<td class="col-md-2">
