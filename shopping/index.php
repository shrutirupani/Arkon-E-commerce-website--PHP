...
<html lang="en">
	<head>
	    ...
	    <title>Arkon Electronic Website</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on order over $200.00</h6>	
				</div>
			</div>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#headphone" data-toggle="tab">HeadPhone</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div class="action"><a <?php if($row['productAvailability']=='Out of Stock'){ ?> disabled
											class="btn disabled" style="text-decoration:line-through;" <?php  } ?> href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Add to Cart</a></div>
			</div><!-- /.product -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Apple Phones</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Acer Laptops</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
