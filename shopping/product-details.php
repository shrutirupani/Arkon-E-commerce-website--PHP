...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="80px" height="104px" alt="">
							</div>
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										...
										?>
										<a <?php if($row['productAvailability']=='Out of Stock'){ ?> disabled
											class="btn disabled" style="text-decoration:line-through;" <?php  } ?>
										href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
										
										<a <?php if($row['productVideo']==''){ ?> disabled
											class="btn disabled" style="text-decoration:line-through;"<?php  } ?>
										data-toggle="tooltip" name="videoFile" data-placement="right" title="Play Video" href="admin/productvideo/<?php echo $row['id'];?>/<?php echo $row['productVideo'];?>" class="lnk btn btn-primary"><i class="fa fa-play"></i>  Video</a>
